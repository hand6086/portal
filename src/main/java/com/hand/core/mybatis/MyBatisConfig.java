...
@Configuration
@MapperScan(basePackages={"com.hand.base.**.mapper","com.hand.core"}) 
public class MyBatisConfig {
	...
	public DataSource dataSource() {
		...
		props.put("driverClass", env.getProperty("spring.datasource.driverClassName"));
        ...
        props.put("maxIdle", env.getProperty("spring.datasource.max-idle"));
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource ds) throws Exception{
        ...
        sfb.setConfigLocation(new ClassPathResource(env.getProperty("mybatis.config-location")));
