...
public class CodeUtil {
    ...
    private static final char[] r=new char[]{'o','q', 'w', 'e', '8', 'a', 's', '2', 'd', 'z', 'x', '9', 'c', '7', 'p', '5', 'i', 'k', '3', 'm', 'j', 'u', 'f', 'r', '4', 'v', 'y', 'l', 't', 'n', '6', 'b', 'g', 'h'};
	...
	public static void main(String[] args){
		...
		String encode =getTransferCode();
		System.out.println(encode);
		sets.add(encode);
		}
		System.out.println("aaaa"+sets.size());
